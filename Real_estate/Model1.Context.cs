...
namespace Real_estate
{
    ...
    public partial class Real_estate_RitaEntities1 : DbContext
    {

        private static Real_estate_RitaEntities1 _context;
        public Real_estate_RitaEntities1()
            : base("name=Real_estate_RitaEntities1")
        {
        }

        public static Real_estate_RitaEntities1 GetContext()
        {
            if (_context == null)
                _context = new Real_estate_RitaEntities1();
            return _context;
        }
        ...
        public virtual DbSet<Type_of_object> Type_of_object { get; set; }
        public virtual DbSet<sysdiagrams> sysdiagrams { get; set; }
        public virtual DbSet<Object_of_realEstate> Object_of_realEstate { get; set; }
